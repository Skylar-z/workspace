...
function(t, e, n, i) {
    ...
    function L(t, e) {
        var n = w(t.touches),
        i = this.targetIds;
        if (e & (Ot | At) && 1 === n.length) return i[n[0].identifier] = !0,
        [n, n];
        ...
        if (r = n.filter(function(t) {
            return f(t.target, c)
        }), e === Ot) for (a = 0; a < r.length;) i[r[a].identifier] = !0,
        a++;
    ...
    c(F, C, {
        handler: function(t) {
            ...
            a & Ot && (0 === t.button || o) ? s < 0 && (e.push(t), s = e.length - 1) : a & (It | Ht) && (n = !0),
            s < 0 || (e[s] = t, this.callback(this.manager, a, {
                pointers: e,
                changedPointers: [t],
                pointerType: r,
                srcEvent: t
    ...
    c(et, tt, {
        ...
        directionTest: function(t) {
            ...
            r = t.deltaX,
            o = t.deltaY;
            return a & e.direction || (e.direction & Rt ? (a = 0 === r ? St: r < 0 ? Yt: Vt, n = r != this.pX, i = Math.abs(t.deltaX)) : (a = 0 === o ? St: o < 0 ? Nt: Ft, n = o != this.pY, i = Math.abs(t.deltaY))),
            t.direction = a,
...
function(t) {
    ...
    t.toast = function(t, a, r) {
        ...
        c = i.duration;
        "cancel" == a ? (o = "weui-toast_cancel", s = "weui-icon-cancel") 
            : "forbidden" == a ? (o = "weui-toast--forbidden", s = "weui-icon-warn") 
            : "text" == a ? o = "weui-toast--text"
            : "number" == typeof a && (c = a),
    ...
    e.prototype.touchMove = function(e) {
        if (!this.container.hasClass("refreshing")) {
            ...
            if (! (this.container.scrollTop() > 0)) {
                ...
                Math.abs(this.diffX) > Math.abs(this.diffY) || void(this.diffY < 0 || (this.container.addClass("touching"), e.preventDefault(), e.stopPropagation(), this.diffY = Math.pow(this.diffY, .75), this.container.css("transform", "translate3d(0, " + this.diffY + "px, 0)"), this.triggerPull(this.diffY)))
            }
        }
    },
    e.prototype.touchEnd = function() {
        this.start = !1,
        this.diffY <= 0 || this.container.hasClass("refreshing") || (this.container.removeClass("touching"), this.container.removeClass("pull-down pull-up"), this.container.css("transform", ""), Math.abs(this.diffY) <= this.opt.distance || this.triggerPullToRefresh())
    },
    ...
    var e = function(e) {
        ...
        c.initPickerCol = function(e, n) {
            ...
            function o(e) {
                ...
                b = (new Date).getTime();
                var n, a;
                b - C > 300 ? a = E: (n = Math.abs(P / (b - O)), a = E + P * c.params.momentumRatio),
...
function(t) {
    ...
    i.prototype._bind = function(e) {
        ...
        }).trigger("change").on("click", ".close-select",
        function() {
            n.close()
        })
    },
...
function(t) {
    ...
    a = function(a) {
        ...
        p.monthHTML = function(t, e) {
            ...
            for (c = 1; c <= h; c++) {
                ...
                for (l = 1; l <= d; l++) {
                    ...
                    var k = m - o,
                    x = "";
                    k < 0 ? (k = a + k + 1, x += " picker-calendar-day-prev", s = new Date(i - 1 < 0 ? n - 1 : n, i - 1 < 0 ? 11 : i - 1, k).getTime()) : (k += 1, k > r ? (k -= r, x += " picker-calendar-day-next", s = new Date(i + 1 > 11 ? n + 1 : n, i + 1 > 11 ? 0 : i + 1, k).getTime()) : s = new Date(n, i, k).getTime()),
        ...
        p.close = function() {
            if (p.opened && !p.inline) return p.animating = !1,
    ...
    i.prototype = {
        ...
        getConfig: function() {
            ...
            r = {
                ...
                value: [e.getFullYear(), n(e.getMonth() + 1), n(e.getDate()), n(e.getHours()), n(e.getMinutes()),n(e.getSeconds())],
...
function(t) {
    ...
    i.prototype.touchMove = function(e) {
        ...
        var n = t.getTouchPosition(e);
        if (this.diffX = n.x - this.start.x, this.diffY = n.y - this.start.y, Math.abs(this.diffX) < Math.abs(this.diffY)) return this.close(),
        this.start = !1,
        !0;
        e.preventDefault(),
        e.stopPropagation();
